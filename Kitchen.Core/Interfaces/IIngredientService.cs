...
public interface IIngredientService
{
    ...
    Task<DbResult<Ingredient>> Get(int id);
    Task<DbResult<Ingredient>> Add(IngredientRequest createIngredientRequest);
    Task<Status> Update(int id, IngredientRequest updateIngredientRequest);
