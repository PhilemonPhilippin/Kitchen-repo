...
public class RecipeIngredientRepo : IRecipeIngredientRepo
{
    ...
    public async Task<IEnumerable<RecipeIngredient>> GetAll(int recipeId)
    {
        ...
        {
            _logger.LogCritical("While getting ingredients in DB for recipe id = {RecipeId}, error = {Ex}", recipeId, ex.Message);
    ...
    public async Task<bool> Add(RecipeIngredient recipeIngredient)
    {
        ...
        {
            _logger.LogCritical("While adding recipe ingredient in DB for recipe id = {RecipeId} and ingredient id = {IngredientId}, error = {Ex}", recipeIngredient.RecipeId, recipeIngredient.IngredientId, ex.Message);
            return false;
        }
    }
    ...
    public async Task<DbResult<bool>> RecipeIngredientExist(RecipeIngredient recipeIngredient)
    {
        ...
        {
            _logger.LogCritical("While querying if recipe ingredient exist for recipe id = {RecipeId} and ingredient id  = {IngredientId}, error = {Ex}", recipeIngredient.RecipeId, recipeIngredient.IngredientId, ex.Message);
    ...
    public async Task<Status> Update(RecipeIngredient recipeIngredient)
    {
        ...
        {
            _logger.LogCritical("While updating recipe ingredient in DB for recipe id = {RecipeId} and ingredient id = {IngredientId}, error = {Ex}", recipeIngredient.RecipeId, recipeIngredient.IngredientId, ex.Message);
            return Status.Error;
        }
    ...
    public async Task<Status> Delete(int recipeId, int ingredientId)
    {
        ...
        {
            _logger.LogCritical("While deleting Recipe Ingredient association in DB, error = {Ex}", ex.Message);
            return Status.Error;
        }
    }
    ...
    private async Task<RecipeIngredient?> GetById(int recipeId, int ingredientId)
    {
        ...
        {
            _logger.LogCritical("While fetching recipe ingredient exist for recipe id = {RecipeId} and ingredient id = {IngredientId}, error = {Ex}", recipeId, ingredientId, ex.Message);
            return null;
        }
    }
}
